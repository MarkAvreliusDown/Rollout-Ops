...
ROUTER_CONFIG_LABELS = {
    ...
    "WANIP": ("IP адрес провайдера ZET", "пример: 172.23.40.146"),
    "WANMASK": ("IP маска провайдера ZET", "пример: 255.255.255.252"),
    "TUNIP": ("IP адрес туннеля ZET", "встречается 2 раза в конфиге — подставится в оба места"),
    "WANGW": ("IP шлюз провайдера ZET", "пример: 172.23.40.145"),
    "WANIP2": ("IP адрес провайдера Provider2", "пример: 172.19.24.106"),
    "WANMASK2": ("IP маска провайдера Provider2", "пример: 255.255.255.248"),
    "TUNIP2": ("IP адрес туннеля Provider2", ""),
    "WANGW2": ("IP шлюз провайдера Provider2", ""),
...
OPENING_CHECKLIST_TEMPLATE = [
    ...
    ("Рассылка графиков", "Сбер"),
    ("Рассылка графиков", "Интернет — Provider2 и ZET"),
